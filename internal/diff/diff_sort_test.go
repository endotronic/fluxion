...
func TestDiffSortOrder(t *testing.T) {
	...
	results, err := CompareSnapshots(mapToIter(filesA), mapToIter(filesB), Options{RootA: rootA, RootB: rootB, HashType: "sha1", NoCopies: false, NoMoves: false, ShowUnchanged: true})
